...
<div class="wrap">
    <div id="poststuff">
        ...
        echo '<div class="notice notice-error">';
            ...
            echo '<p>WP LinkedIn Auto Publish has now been put into maintenance mode which means we are only going to maintain the core functionality and provide limited support. However we are now focusing our efforts on our new plugin <a href="https://northernbeacheswebsites.com.au/autosocial/">AutoSocial</a> which provides the same functionality as WP LinkedIn Auto Publish but adds Facebook, Google My Business and Twitter and many more cool features!</p>';

            echo '<p>By moving everything to one premium plugin it means I can better consolidate my development time and release new features and provide better support.</p>';
